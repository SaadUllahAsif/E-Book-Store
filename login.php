    ...
    {   
        ...
        if(isset($_POST['login']))
        {
            ...
            if($result == 1)
            {
                ...
                $_SESSION['method']=$check['method'];
                $_SESSION['number']=$check['mobilenumber'];
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>E Book Login/Registration</title>
                    ...
                    <div class="col-lg-6">
                        <div class="login-form">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>E-mail </label>
                                    <input class="form-control" type="text" name="loginemail" placeholder="E-mail">
                                </div>
                                <div class="col-md-6">
                                    <label>Password</label>
