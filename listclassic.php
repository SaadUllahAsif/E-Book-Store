    ...
    if(isset($_POST["add"])){
        if(isset($_SESSION["cart"])){
            ...
            if(!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script> window.location="listclassic.php" </script>';
            }else{
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <?php
                                ...
                                $query=" SELECT * FROM `book` WHERE `category` = 'Calssic' ";
                                ...
                                ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <form method="post" action="listclassic.php?action=add&id=<?php echo $row["id"] ?>">
