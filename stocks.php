        ...
        if($data)
        {
          while($row = $data->fetch_assoc())
          {
            echo "<tr><td>" .$row["bookno"]."</td><td>" .$row["category"]. "</td><td>" .$row["name"]. 
                  "</td><td>" .$row["author"]. "</td><td>" .$row["price"]. "</td>";
                  print'<td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter">UPDATE</button>';
                                          ...
                                          <div class="col-lg-6">    
                                              <div class="register-form">
                                                  <div class="row">
                                                              ...
                                                              <input class="form-control" type="text" name="updatenumber" placeholder="Book Number">

                                                              <label>Category</label>
                                                              <input class="form-control" type="text" name="updatecategory" placeholder="Book Category">
                                                        
                                                              <label>Name</label>
                                                              <input class="form-control" type="text" name="updatename" placeholder="Book Name">
                                                        
                                                              <label>Auther</label>
                                                              <input class="form-control" type="text" name="updateauthor" placeholder="Book Author">
                                                        
                                                              <label>Price</label>
                                                              <input class="form-control" type="text" name="updateprice" placeholder="Book Price">
                                                  </div>
                                              </div>
                                          </div>
