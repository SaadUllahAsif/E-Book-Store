    ...
    if(isset($_POST["add"])){
        if(isset($_SESSION["cart"])){
            ...
            if(!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script> window.location="listaction copy.php" </script>';
            }else{
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>E Books Action & Adventure</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="user">
                            ...
                            <a href="http://localhost/ebook/cart copy.php" class="btn cart">
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Action & Adventure</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <?php
                            ...
                            $query=" SELECT * FROM `book` WHERE `category` = 'Action & Adventure' ";
                        ...
                        ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <form method="post" action="listaction copy.php?action=add&id=<?php echo $row["id"] ?>">
