<?php
  ...
  if(isset($_POST['add']))
  {
    ...
    $query="INSERT INTO `purchase`(`bookname`, `price`, `quantity`) VALUES ('$bookname','$quantity','$price')";
      ...
      <div class="page-wrapper">
          ...
          <div class="content">					<div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5">
						<div class="d-flex justify-content-between">
							<h2 class="text-dark font-weight-medium">Purchase  Report</h2>
              ...
              <?php 
                ...
                $query="SELECT `bookname`, `price`, `quantity` FROM `purchase`";
                $data= mysqli_query($con,$query);
                if($data){
                  while($row = $data->fetch_assoc()){
                    $cast=($row['quantity']*$row['price']);
                    $total=($total+ $cast);
                    echo "<tr><td>".$row['bookname']."</td><td>".$row['quantity']."</td><td> $".$row['price']."</td><td> $".$cast."</td></tr><br>";
                  }
                  ?>
                  <tr>
                    <td colspan="3" align:right;> Total Purchase </td>
                    <td> $ <?php echo number_format( $total, decimals: 2); ?> </td>
                  </tr>
                  ...
                  echo '<script>alert("Failed to generate sales report!")</script>'; 
                }
                                          ...
                                          <div class="col-lg-6">    
                                              <div class="register-form">   
                                                  <div class="row">
                                                    ...
                                                    <label>Price</label>
                                                    <input class="form-control" type="text" name="price" placeholder="Book Price">
                                                        
                                                    <label>Quantity</label>
                                                    <input class="form-control" type="text" name="quantity" placeholder="Book Quantity">
