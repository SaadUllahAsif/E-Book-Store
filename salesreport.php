      ...
      <div class="page-wrapper">
          ...
          <div class="content">					<div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5">
						<div class="d-flex justify-content-between">
							<h2 class="text-dark font-weight-medium">Sales Report</h2>
                            <div class="btn-group">
							</div>
						</div>
              ...
              <?php 
                ...
                $query="SELECT  `date`, `bookname`, `price` FROM `orders`";
                $data= mysqli_query($con,$query);
                if($data){
                  while($row = $data->fetch_assoc()){
                    $sales=($sales+$row['price']+2);
                    
                    echo "<tr><td>".$row['date']."</td><td>".$row['bookname']."</td><td>".$row['price']."</td></tr><br>";
                  }
                  ?>
                  <tr>
                    <td colspan="2" align:right;> Total Sales </td>
                    <td> $ <?php echo number_format( $sales, decimals: 2); ?> </td>
                  </tr>
