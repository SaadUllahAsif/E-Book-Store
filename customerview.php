<?php 
    ...
    if(isset($_POST['register']))
    {
        ...
        {
            $query="INSERT INTO `customer`(`firstname`, `lastname`, `email`,`mobilenumber`, `password`, `confirmpassword`) VALUES 
        ...
        if($data)
        {
          while($row = $data->fetch_assoc())
          {
            echo "<tr><td>" .$row["firstname"]."</td><td>" .$row["lastname"]. "</td><td>" .$row["email"]. 
                  "</td><td>" .$row["mobilenumber"]. "</td><td>" .$row["address"]. "</td><td>" .$row["method"].
                ...
                <div class="card card-mini mb-4">   -->
                    ...
                    <!-- <div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Update Customer Data</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                ...
                                <div class="col-lg-6">    
                                              <div class="register-form">
                                                  <div class="row">
                                                              ...
                                                              <input class="form-control" type="text" name="deletenumber" placeholder="Customer Email">
