    ...
    if(isset($_POST["add"])){
        if(isset($_SESSION["cart"])){
            ...
            if(!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script> window.location="listhistoric.php" </script>';
            }else{
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>E Books Historical</title>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <?php
                            ...
                            $query=" SELECT * FROM `book` WHERE `category` = 'Historic' ";
                        ...
                        ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <form method="post" action="listhistoric.php?action=add&id=<?php echo $row["id"] ?>">
